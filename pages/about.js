...
const about = () => {
  return (
    <div>
            ...
            <Navbar />
            <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4 dark:text-white">
                ...
                <div className="flex lg:flex-row flex-col lg:gap-8 sm:gap-10 gap-12">
                    <div className="w-full lg:w-6/12">
                        <h2 className="w-full font-bold lg:text-4xl text-3xl lg:leading-10 leading-9">We are here to help you build your business at a very affordable rate</h2>
                        <p className="font-normal text-base leading-6 text-gray-600 dark:text-white dark:text-white mt-6">Nazra Software Solutions a team of professionals with of experience in IT development. Professionalism, Skill, and Expertise are the tools we use to make the work of your business bringing in maximum return on your investment in shortest possible time.

                        </p>
                        <p className="font-normal text-base leading-6 text-gray-600 dark:text-white dark:text-white mt-6">
                            Our team works closely with the clients to build, run and leverage solutions that help your businesses to succeed in this rapidly changing and challenging the world. The company constantly upgrades the skills of the employees to keep up with the latest technologies and deliver maximum value to the clients.
                            Nazra Software Solutions Specializes in custom Software development, Web designing, Web development, E-commerce Website development, Mobile app development.
...
{/* 
                ...
                <div className="grid sm:grid-cols-3 grid-cols-2 sm:gap-8 gap-4">
                    <div>
                        <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-gray-800 dark:text-white dark:text-white mt-6">Founded</p>
                        <p className="font-normal text-base leading-6 text-gray-600 dark:text-white dark:text-white mt-6">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
                    </div>
                    <div>
                        <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-gray-800 dark:text-white dark:text-white mt-6">50M montly enrichments</p>
                        <p className="font-normal text-base leading-6 text-gray-600 dark:text-white dark:text-white mt-6">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
                    </div>
                    <div className="sm:block hidden">
                        <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-gray-800 dark:text-white dark:text-white mt-6">400k User</p>
                        <p className="font-normal text-base leading-6 text-gray-600 dark:text-white dark:text-white mt-6">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
                    </div>
                </div>
                ...
                <div className="flex lg:flex-row-reverse flex-col md:gap-14 gap-16 justify-between lg:mt-20 mt-16">
                    <div className="w-full lg:w-6/12">
                        <h2 className="font-bold lg:text-4xl text-3xl lg:leading-9 leading-7 text-gray-800 dark:text-white">Our Mission</h2>
                        <p className="font-normal text-base leading-6 text-gray-600 dark:text-white mt-6 w-full lg:w-10/12 xl:w-9/12">A NazraSoft, we are a single force of excellence driven by a collective of individual voices.
                            We encourage a culture that build up individual creativity and teamwork, value- honoring mutual trust and respect while maintaining uncompromising principles of honesty, disruption, creativity, technology enablement, agility and result orientation.
                        </p>
                        <p className="font-normal text-base leading-6 text-gray-600 dark:text-white w-full lg:w-10/12 xl:w-9/12 mt-10">It is our mission to provide comprehensive consultation and inspiring solutions towards the development, creation, implementation, and measurement of consumer engagement for our clients.
                            We believe in creating result-adapt partnerships, which embrace mutual respect, dignity and long-term value creation. We invest in creating advanced technologies, action-provoking communication, providing outstanding products and services that fulfill the needs of those we value most.
                        </p>
                    </div>
                    <div className="w-full lg:w-6/12">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 lg:gap-12 gap-10">
                            ...
                            {/* <div className="flex p-4 shadow-md"> */}
                                ...
                                <div className="">
                                    ...
                                    <p className="mt-2 font-normal text-base leading-6 text-gray-600 dark:text-white">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
                                </div>
                            </div> */}
