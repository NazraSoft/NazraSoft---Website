    ...
    return (
        <div className="xl:flex xl:justify-end pt-16">
            <div className="container sm:mx-auto">
                <div className="block xl:flex justify-between xl:items-center lg:items-center md:flex text-center">
                    <div className="w-11/12 xl:w-4/12 mx-auto xl:mx-0 md:w-5/12">
                        <h1 className="text-gray-800 dark:text-white text-3xl font-extrabold mb-3 pt-12 xl:pt-0">Sign Up for Product Updates</h1>
                    ...
                    <div className="w-11/12 xl:w-5/12 mx-auto xl:mx-0 mt-8 xl:mt-0 flex justify-end md:w-5/12 bg-indigo-100 relative py-20">
                        <div className="h-4/5 w-4/5">
                            <img src="https://cdn.tuk.dev/assets/photo-1496430689199-7d6a8ebd3a2f.jfif" alt="true" className="h-full w-full overflow-hidden object-cover relative z-10 xl:-ml-56 lg:-ml-32 sm:-ml-20 -ml-12 md:-ml-20 rounded" />
                        </div>
