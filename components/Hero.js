...
<div class="flex flex-col justify-between md:flex-row md:px-12 lg:px-20 p-4 dark:bg-gray-800 transition duration-500">
  <div class="text-container md:mt-10 md:w-1/2">
    {/* <p class="text-black bg-gray-200 dark:bg-gray-700 rounded-md px-2 py-1 text-sm inline-block dark:text-white my-4">
      <span class="bg-blue-500 px-2 py-1/2 rounded-md text-white">Pro</span> comes with */}
      {/* <svg viewBox="0 0 128 128" class="h-5 w-5 inline-block">
      ...
      {/* support */}
    {/* </p> */}
    <h1 class="text-2xl md:text-4xl text-black font-bold dark:text-white tracking-normal leading-10"><span class="text-tmk-blue">Handcrafted, professional </span>Website and App for your Business</h1>
    ...
    <h2 class="text-gray-700 text-lg font-light dark:text-white mt-8">
      ...
      <span class="dark:text-white text-black font-semibold">quicker</span>
    ...
    <div class="flex mt-8 md:flex-row items-baseline space-x-4">
      ...
      <div>
        <h3 class="text-gray-700 md:text-lg font-light dark:text-white ml-4 mt-4">
    ...
    <div class="buttons-container flex space-x-2 md:space-x-4 text-white dark:text-white my-12">
      <a href='/about' class="font-semibold rounded-md text-sm md:text-base bg-blue-500 px-4 py-2 md:px-8 md:py-4 cursor-pointer transform transition duration-200 hover:shadow-xl hover:-translate-y-1"> <span class="hidden lg:inline-block">Get</span> Quote </a>
      <a href='/plans' class="font-semibold rounded-md text-sm md:text-base bg-red-500 px-4 py-2 md:px-8 md:py-4 cursor-pointer transform transition duration-200 hover:shadow-xl hover:-translate-y-1"> <span class="hidden lg:inline-block">View</span> Plans </a>
    </div>
  </div>
